...
function test_populateDummyDataToSpreadsheet(){
  ...
  return "Spreadsheet populated with Dummy Data"
}
...
function test_allotForAllStudents(){
  ...
  return "Allotment Matrix Done"
}

function test_createAllotmentMatrixAndGenerateDeptWiseMatrix(){
  test_allotForAllStudents();
  createAndFormatDepartmentSheets();
  return 'Allotment matrix,\n Dept Wise matrix Done'
}
